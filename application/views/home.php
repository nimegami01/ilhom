...
<head><meta http-equiv="Content-Type" content="text/html; charset=euc-jp">
	...
	<title>Penjualan Buku Documentation</title>
...
<body>
	...
	<h2 class="mb-5 text-center">TUGAS WEB SERVICE (CODEIGNITER API) - PENJUALAN BUKU</h2>
